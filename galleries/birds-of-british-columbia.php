...
<html>
  ...
  <head>
    ...
    <meta name="description" content="JoAnne Fillatti's photography of birds in British Columbia.">
    <meta name="keywords" content="JoAnne Fillatti, photography, birds, British Columbia">
    ...
    <meta property="og:title" content="Birds of British Columbia | Joanne Fillatti">
    <meta property="og:description" content="JoAnne Fillatti's photography of birds in British Columbia.">
  	<title>Birds of British Columbia | Joanne Fillatti</title>
  </head>
  ...
  <body>
    ...
    <div class="content">
      <!-- Gallery title -->
      <h3>Birds of British Columbia</h3>
      ...
      <div class="gallery">
        ...
        foreach (glob("../images/birds/british columbia/*.{JPG,jpg,gif,png,bmp}", GLOB_BRACE) as $img_file) {
        ?>
          <img class="gallery-img" src="<?php echo $img_file; ?>" alt="bird of british columbia image <?php echo $i; ?>" onclick="openModal();currentModal(<?php echo $i; ?>)" />
        <?php
          $i++;
        }
        ?>
      ...
      <div id="modal-id" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-container" onclick="clickImage(event)">
            <img class="modal-img" src="<?php echo $img_file; ?>" alt="bird of british columbia modal image" />
            <?php
            $file_name = pathinfo($img_file);
            $info_file = "../images/birds/british columbia/captions/" . $file_name['filename'] . ".txt";
