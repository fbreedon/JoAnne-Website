...
<html>
  ...
  <head>
    ...
    <meta name="description" content="JoAnne Fillatti's photography of birds in Utqiagvik, Alaska.">
    <meta name="keywords" content="JoAnne Fillatti, photography, birds, Utqiagvik, Alaska">
    <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png">
    <link rel="manifest" href="/site.webmanifest">
    <meta property="og:image:url" content="./images/birds/utqiagvik (barrow) alaska/01-King Eider.jpg">
    <meta property="og:image:width" content="2039">
    <meta property="og:image:height" content="2039">
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://joannefillatti.com/">
    <meta property="og:title" content="Birds of Utqiagvik, Alaska | Joanne Fillatti">
    <meta property="og:description" content="JoAnne Fillatti's photography of birds in Utqiagvik, Alaska.">
  	<title>Birds of Utqiagvik, Alaska | Joanne Fillatti</title>
  </head>
  ...
  <body>
    ...
    <div class="content">
      <!-- Gallery title -->
      <h3>Birds of Utqiagvik, Alaska</h3>
      ...
      <div class="gallery">
        ...
        foreach (glob("../images/birds/utqiagvik (barrow) alaska/*.{JPG,jpg,gif,png,bmp}", GLOB_BRACE) as $img_file) {
        ?>
          <img class="gallery-img" src="<?php echo $img_file; ?>" alt="bird of Utqiagvik image <?php echo $i; ?>" onclick="openModal();currentModal(<?php echo $i; ?>)" />
        <?php
          $i++;
        }
        ?>
      ...
      <div id="modal-id" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-container" onclick="clickImage(event)">
            <img class="modal-img" src="<?php echo $img_file; ?>" alt="bird of utqiagvik modal image" />
            <?php
            $file_name = pathinfo($img_file);
            $info_file = "../images/birds/utqiagvik (barrow) alaska/captions/" . $file_name['filename'] . ".txt";
