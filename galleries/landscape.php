...
<html>
  ...
  <head>
    ...
    <meta name="description" content="JoAnne Fillatti's photography of  landscapes.">
    <meta name="keywords" content="JoAnne Fillatti, photography, landscape">
    ...
    <meta property="og:title" content="Landscape | Joanne Fillatti">
    <meta property="og:description" content="JoAnne Fillatti's photography of landscapes.">
  	<title>Landscape | Joanne Fillatti</title>
  </head>
  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="gallery">
        ...
        foreach (glob("../images/landscape/*.{JPG,jpg,gif,png,bmp}", GLOB_BRACE) as $img_file) {
        ?>
          <img class="gallery-img" src="<?php echo $img_file; ?>" alt="landscape image <?php echo $i; ?>" onclick="openModal();currentModal(<?php echo $i; ?>)" />
        <?php
          $i++;
        }
        ?>
      ...
      <div id="modal-id" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-container" onclick="clickImage(event)">
            <img class="modal-img" src="<?php echo $img_file; ?>" alt="landscape modal image" />
            <?php
            $file_name = pathinfo($img_file);
            $info_file = "../images/landscape/captions/" . $file_name['filename'] . ".txt";
