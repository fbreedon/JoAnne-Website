...
<html>
  ...
  <head>
    ...
    <meta name="description" content="JoAnne Fillatti's photography of birds in Australia.">
    <meta name="keywords" content="JoAnne Fillatti, photography, birds, Queensland, Tasmania, Australia">
    <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png">
    <link rel="manifest" href="/site.webmanifest">
    <meta property="og:image:url" content="./images/birds/australia/01-Cassowary.jpg">
    <meta property="og:image:width" content="2039">
    <meta property="og:image:height" content="2039">
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://joannefillatti.com/">
    <meta property="og:title" content="Birds of Queensland and Tasmania, Australia | Joanne Fillatti">
    <meta property="og:description" content="JoAnne Fillatti's photography of birds in Australia.">
  	<title>Birds of Queensland and Tasmania, Australia | Joanne Fillatti</title>
  </head>
  ...
  <body>
    ...
    <div class="content">
      <!-- Gallery title -->
      <h3>Birds of Queensland and Tasmania, Australia</h3>
      ...
      <div class="gallery">
        ...
        foreach (glob("../images/birds/australia/*.{JPG,jpg,gif,png,bmp}", GLOB_BRACE) as $img_file) {
        ?>
          <img class="gallery-img" src="<?php echo $img_file; ?>" alt="bird of australia image <?php echo $i; ?>" onclick="openModal();currentModal(<?php echo $i; ?>)" />
        <?php
          $i++;
        }
        ?>
      ...
      <div id="modal-id" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-container" onclick="clickImage(event)">
            <img class="modal-img" src="<?php echo $img_file; ?>" alt="bird of australia modal image" />
            <?php
            $file_name = pathinfo($img_file);
            $info_file = "../images/birds/australia/captions/" . $file_name['filename'] . ".txt";
