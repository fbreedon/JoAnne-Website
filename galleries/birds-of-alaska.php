  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="gallery">
        ...
        ?>
          <img class="gallery-img" src="<?php echo $img_file; ?>" alt="bird of alaska image <?php echo $i; ?>" onclick="openModal();currentModal(<?php echo $i; ?>)" />
        <?php
          $i++;
        }
        ?>
      ...
      <div id="modal-id" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-container" onclick="clickImage(event)">
            <img class="modal-img" src="<?php echo $img_file; ?>" alt="bird of alaska modal image" />
            <?php
