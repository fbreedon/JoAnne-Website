...
<html>
  ...
  <head>
    ...
    <meta property="og:image:url" content="./images/birds/ecuador/01-White-necked Jacobin-2.jpg">
  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="gallery">
        ...
        foreach (glob("../images/birds/ecuador/*.{JPG,jpg,gif,png,bmp}", GLOB_BRACE) as $img_file) {
        ?>
          <img class="gallery-img" src="<?php echo $img_file; ?>" alt="bird of ecuador image <?php echo $i; ?>" onclick="openModal();currentModal(<?php echo $i; ?>)" />
        <?php
          $i++;
        }
        ?>
      ...
      <div id="modal-id" class="modal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-container" onclick="clickImage(event)">
            <img class="modal-img" src="<?php echo $img_file; ?>" alt="bird of ecuador modal image" />
            <?php
            $file_name = pathinfo($img_file);
            $info_file = "../images/birds/ecuador/captions/" . $file_name['filename'] . ".txt";
